    ...
    <div className='flex flex-col justify-center md:items-center md:justify-between md:flex-row gap-5  '>
        <div className='flex flex-col gap-5 md:gap-3'>
            ...
            <div className='flex flex-col md:flex-row gap-2.5'>
                <span className='border flex gap-3.5 bg-[#C8F400] text-black items-center p-3 w-fit font-medium text-sm  rounded-xl'>Shop Now <MoveRight/></span>
                <span className='border items-center p-3 w-fit text-white/70 text-sm  rounded-xl'>View All Products</span>
            </div>
        </div>
